...
1.  **Metadata**: A list of numbers, encoded according to the first-byte strategy (varint, fixed16, etc).
    ...
    Start and end positions are encoded independently using the same strategy.
